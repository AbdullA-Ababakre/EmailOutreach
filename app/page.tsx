      ...
      complete: async (results) => {
        try {
          ...
          if (response.status === 200) {
            messageApi.open({
              type: 'success',
              content: 'Sent Emails successfully',
            });
          } else {
            messageApi.open({
              type: 'error',
    ...
    <AnimatePresence>
      ...
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden">
        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          ...
          >
            Enhance your <br />
            Email <span className="text-[#407BBF]">outreach</span>
            ...
            >
              ...
              >
                <form onSubmit={handleUpload}>
                  ...
                  <button className="mr-2 mt-2.5 md:mt-0" type="submit">Upload your Email CSV file</button>
                </form>
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
